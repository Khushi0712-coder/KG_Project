          ...
          <div className="row g-4">
            ...
            <div className="col-md-4 col-sm-6">
              <div className="review-card">
                ...
                <div className="stars">★★★★★</div>
                <p className="text-muted">
                  "The quality is exceptional! I’ve been using saffron for years,
                  and this is by far the best I’ve tried."
                </p>
                <p className="verified">
                  <i className="fas fa-check-circle"></i> Verified Purchase
                </p>
            ...
            <div className="col-md-4 col-sm-6">
              <div className="review-card">
                ...
                <div className="stars">★★★★★</div>
                <p className="text-muted">
                  "As a professional chef, I demand the best ingredients. Kishtwar
                  Gold delivers authentic saffron that elevates every dish."
                </p>
                <p className="verified">
                  <i className="fas fa-check-circle"></i> Verified Purchase
                </p>
            ...
            <div className="col-md-4 col-sm-6">
              <div className="review-card">
                ...
                <div className="stars">★★★★☆</div>
                <p className="text-muted">
                  "Perfect for special occasions. The packaging is elegant and the
                  saffron quality is outstanding. Highly recommended!"
                </p>
                <p className="verified">
                  <i className="fas fa-check-circle"></i> Verified Purchase
                </p>
